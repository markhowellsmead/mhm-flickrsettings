...
class MHMFlickrSettings {
	...
	function init_flickrsettings() {
		...
		register_setting( 'media', 'flickr_key', 'esc_attr' );
		register_setting( 'media', 'flickr_secret', 'esc_attr' );
		register_setting( 'media', 'flickr_userid', 'esc_attr' );
	...
	function field_key() {
		echo '<input name="flickr_key" id="flickr_key" type="text" value="' . esc_attr(get_option( 'flickr_key' )) . '" class="regular-text ltr" />';
	}
	function field_secret() {
		echo '<input name="flickr_secret" id="flickr_secret" type="text" value="' . esc_attr(get_option( 'flickr_secret' )) . '" class="regular-text ltr" />';
	}
	function field_userid() {
		echo '<input name="flickr_userid" id="flickr_userid" type="text" value="' . esc_attr(get_option( 'flickr_userid' )) . '" class="regular-text ltr" />';
	}
